...
% theta2 = [0 0 180];
%% Casos aleatorios
li=7;%limite de coordenadas, maximo 5.
...
hold on;
plot (cmxm_1,cmym_1,'o','LineWidth', 2,'color','yellow');
hold on;
plot (mmxm_1,mmym_1,'o','LineWidth', 2,'color','red');
hold on;
plot (chxm_1,chym_1,'o','LineWidth', 2,'color','black');
figure(2)
graf_personas(x2,y2,theta2);
hold on;
plot (cmxm_2,cmym_2,'o','LineWidth', 2,'color','yellow');
hold on;
plot (mmxm_2,mmym_2,'o','LineWidth', 2,'color','red');
hold on;
plot (chxm_2,chym_2,'o','LineWidth', 2,'color','black');